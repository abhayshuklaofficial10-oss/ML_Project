...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        """
        Apply preprocessing on train and test data and save the preprocessor object.
        """
        try:
            ...
            logging.info(
                f"Saving preprocessor at {self.data_transformation_config.preprocessor_obj_file_path}"
            )
